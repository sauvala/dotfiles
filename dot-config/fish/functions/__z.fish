function __z -d "Jump to a recent directory."
    function __print_help -d "Print z help."
        ...
        printf "         -d --dir      Opens matching directory using system ***REMOVED***le manager.\n"
    ...
    function __z_legacy_escape_regex
        # taken from escape_string_pcre2 in ***REMOVED***sh
        # used to provide compatibility with ***REMOVED***sh 2
    ...
    set -l z_script '
        ...
        function common(matches) {
            # ***REMOVED***nd the common root of a list of matches, if it exists
            for( x in matches ) {
